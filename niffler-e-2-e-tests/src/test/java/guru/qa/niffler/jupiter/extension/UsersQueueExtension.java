...
public class UsersQueueExtension implements
  ...
  static {
    ...
    WITH_FRIEND_USERS.add(new StaticUser("didi", "1234", "diki", null, null));
    WITH_INCOME_REQUEST_USERS.add(new StaticUser("givemenewfriend", "123", null, "test", null));
    WITH_OUTCOME_REQUEST_USERS.add(new StaticUser("test", "12341234", null, null, "givemenewfriend"));
  }
